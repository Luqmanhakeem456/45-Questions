...
var album1 = make_album("Alif Aslam", "Jughno ke kahani");
var album2 = make_album("Iqbal", "Jawab-Shikwa");
var album3 = make_album("Atish Raj", "Darya aur pahar");
console.log(album1);
console.log(album2);
console.log(album3);
function make_album2(artistName, albumTitle, numberOfTracks) {
    return { artistName: artistName, albumTitle: numberOfTracks };
}
var album4 = make_album2("Rahman Baba", "Dunya ke haqiqat", 10);
var album5 = make_album2("Akber", "Wafa ke tasawor", 23);
var album6 = make_album2("Younus", "Kabe khuse kabe Ghum", 30);
console.log(album4);
console.log(album5);
console.log(album6);
